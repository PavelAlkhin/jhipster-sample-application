...
import { FoldersComponent } from 'app/entities/folders/folders.component';
import { FoldersService } from 'app/entities/folders/folders.service';
import { Folders } from 'app/shared/model/folders.model';

describe('Component Tests', () => {
  describe('Folders Management Component', () => {
    let comp: FoldersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FoldersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.folders && comp.folders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
