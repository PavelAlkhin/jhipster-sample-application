...
import { FoldersDeleteDialogComponent } from 'app/entities/folders/folders-delete-dialog.component';
import { FoldersService } from 'app/entities/folders/folders.service';

describe('Component Tests', () => {
  describe('Folders Management Delete Component', () => {
    let comp: FoldersDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [FoldersDeleteDialogComponent],
      })
        .overrideTemplate(FoldersDeleteDialogComponent, '')
        .compileComponents();
