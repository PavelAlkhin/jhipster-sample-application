...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, eco.vessel.doc.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, eco.vessel.doc.repository.UserRepository.USERS_BY_EMAIL_CACHE);
