...
export class DocumentsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.documentsService
      ...
      .subscribe(
        (res: HttpResponse<IDocuments[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDocuments(): void {
    this.eventSubscriber = this.eventManager.subscribe('documentsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDocuments[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
